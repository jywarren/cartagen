...
/***** THIS SHOULD BE COPIED TO ANY UPGRADED VERSION OF THIS TEMPLATE *****/

// makeWikiLink('Feature', 'apply_default_styles')
// => "http://wiki.cartagen.org/wiki/show/Feature{apply_default_styles}
function makeWikiLink(klass, name) {
	var wiki_link = "http://wiki.cartagen.org/wiki/show/" + klass
	if (name) wiki_link += "{" + name + "}"
	return wiki_link
}
